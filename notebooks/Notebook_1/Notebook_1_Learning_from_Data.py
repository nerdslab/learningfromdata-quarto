...
# **Instructor:** Eva Dyer
#
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nerdslab/learningfromdata-course/blob/main/notebooks/Notebook_1/Notebook_1_Learning_from_Data.ipynb)
#
# ## Module Theme
#
...
# %% [markdown]
# ### Transition: From Case Studies to Computation
#
# The case studies show that learning from data requires judgment.
#
# Now we need computational tools for working with the building blocks we identified:
#
# - examples,
# - features,
# - targets,
...
# - and transformations.
#
# This is where Python, NumPy, and linear algebra enter the course.
#
# Linear algebra is not a separate math detour. It is the language we use to represent data and models.
#
...
# 5. Probability, variance, and covariance as ways to describe uncertainty and data shape.
# 6. Images and tables as concrete data types.
#
...
#
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nerdslab/learningfromdata-course/blob/main/notebooks/Notebook_1/Notebook_1_Learning_from_Data.ipynb#scrollTo=ex-matrix-diagnose)
#
...
# ### Practice
#
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nerdslab/learningfromdata-course/blob/main/notebooks/Notebook_1/Notebook_1_Learning_from_Data.ipynb#scrollTo=ex-matrix-practice)
#
...
#
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nerdslab/learningfromdata-course/blob/main/notebooks/Notebook_1/Notebook_1_Learning_from_Data.ipynb#scrollTo=ex-image-representation)
#
